...
export const blogPosts: BlogPostMeta[] = [
  ...
  },
  {
    ...
    readingTimeMinutes: 4,
    title: '41A door een 40A-beveiliging? Zo voorkom je fouten met somstromen bij PV-installaties',
    seoTitle: 'Somstromen bij PV: 41A op 40A voorkomen',
    description:
      'Praktische uitleg voor installateurs: hoe somstromen bij PV-installaties ontstaan, wat u moet controleren, en wat Scope 12 hiermee te maken heeft.',
    date: '2026-08-28',
    excerpt:
      'Een 16A-omvormer op een bestaande 25A-aansluiting kan 41A door een 40A-aardlekschakelaar sturen. Zo herkent en beoordeelt u somstromen vóór u de offerte verstuurt.',
    tags: ['NEN 1010', 'SciOS Scope 12', 'Somstromen', 'PV-installatie', 'Zonnepanelen', 'Selectiviteit'],
    keyPoints: [
      'Een combinatie van 25A netvoeding en 16A PV-invoeding kan 41A op een 40A-aardlekschakelaar geven — controleer dit per installatie, niet als vuistregel.',
      'Voor invoeding boven circa 3,68 kW (16A) enkelfase eist de netbeheerder doorgaans verdeling over 3 fasen — check de aansluitvoorwaarden van de klant.',
      'SciOS Scope 12 en NEN-EN-IEC 62446 zijn relevant voor de verzekerbaarheid van zakelijke PV-installaties, maar zijn geen garantie op zichzelf.',
      'Technische onderbouwing in de offerte maakt risico’s vooraf zichtbaar in plaats van achteraf.',
    ],
    category: 'Zonnepanelen',
    faq: [
      { question: 'Wat is een somstroom bij een PV-installatie?', answer: 'Een somstroom is de gecombineerde stroom die ontstaat wanneer meerdere stroombronnen — bijvoorbeeld het net en de omvormer — gelijktijdig bijdragen aan hetzelfde circuit of dezelfde beveiliging. De som kan hoger zijn dan de nominale stroom van die beveiliging.' },
      { question: 'Waarom moet je meerdere stroombronnen samen beoordelen?', answer: 'Een beveiliging is berekend op de stroom die er doorheen loopt, ongeacht de bron. Netvoeding en PV-invoeding tellen op als ze dezelfde aardlekschakelaar delen — beoordeel je ze los, dan mis je een reële overbelastingssituatie.' },
      { question: 'Wanneer is faseverdeling relevant?', answer: 'Bij invoeding boven circa 3,68 kW (16A) enkelfase eisen netbeheerders doorgaans verdeling over meerdere fasen, om fase-onbalans op het net te beperken. De exacte grens en eis staan in de aansluitvoorwaarden van de netbeheerder van de klant.' },
      { question: 'Wat is de relatie tussen technische onderbouwing en Scope 12?', answer: 'Scope 12 is een inspectieschema dat (met name bestaande) PV-installaties beoordeelt op brandrisico. Een goed onderbouwd ontwerp en oplevering maken die inspectie makkelijker te doorstaan, maar vervangen die inspectie niet.' },
    ],
  },
  {
