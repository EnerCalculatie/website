      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          <h2 className="font-display text-2xl md:text-4xl font-bold text-slate-900 mb-6 relative z-10">
            Bouw mee aan het platform, niet er alleen mee
          </h2>

          <p className="text-lg text-slate-600 mb-4 max-w-2xl mx-auto leading-relaxed relative z-10">
            EnerCalculatie is gebouwd door één ontwikkelaar die de rekenmodules zelf onderhoudt — geen supportdesk, wel een rechtstreekse lijn. Zonnepanelen, thuisbatterij, warmtepomp, airco en laadpaal draaien nu al live; als early adopter bepaalt u mee wat er als volgende bijkomt.
          </p>
          <p className="text-lg text-slate-600 mb-8 max-w-2xl mx-auto leading-relaxed relative z-10">
            Speciale voorwaarden voor de eerste installateurs die instappen.
          </p>
          ...
          >
            Praat met de bouwer, geen sales
