  ...
  return (
    <>
      <SEO 
        ...
        description="Het privacy statement van EnerCalculatie: hoe wij als verwerker AVG-compliant omgaan met de data van uw installatiebedrijf en uw eindklanten."
      ...
      <div className="pt-24 md:pt-32 pb-16 md:pb-24 bg-slate-50 min-h-screen">
        ...
        <div className="animate-fade-up prose prose-slate max-w-none">
          ...
          <h2 className="text-xl md:text-2xl font-bold text-slate-800 mt-8 mb-4">1. Rol van EnerCalculatie (AVG)</h2>
          <p className="text-slate-700 leading-relaxed mb-4">
            ...
            Dit betekent dat wij de gegevens van uw eindklanten uitsluitend verwerken in uw opdracht en ten behoeve van het genereren van energieberekeningen, offertes en adviesrapportages.
          </p>

          <h2 className="text-xl md:text-2xl font-bold text-slate-800 mt-8 mb-4">2. Welke data verwerken wij?</h2>
          ...
          <h2 className="text-xl md:text-2xl font-bold text-slate-800 mt-8 mb-4">4. Bewaartermijnen</h2>
          <p className="text-slate-700 leading-relaxed mb-4">
          ...
          <h2 className="text-xl md:text-2xl font-bold text-slate-800 mt-8 mb-4">5. Rechten van betrokkenen</h2>
          <p className="text-slate-700 leading-relaxed mb-4">
