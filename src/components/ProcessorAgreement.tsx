    ...
    <>
      ...
      <div className="pt-24 md:pt-32 pb-16 md:pb-24 bg-slate-50 min-h-screen">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="prose prose-slate max-w-none">
          ...
          <h1 className="text-2xl md:text-4xl font-black text-slate-900 mb-8">Verwerkersovereenkomst (AVG Art. 28) - EnerCalculatie</h1>
          <p className="text-slate-600 mb-4">Laatst gewijzigd: 15 juni 2026</p>
          <p className="text-slate-600 mb-8 italic text-sm">Deze overeenkomst maakt integraal onderdeel uit van de <a href="/voorwaarden" className="text-brand-primary font-medium hover:underline">Algemene Voorwaarden</a> en de overeenkomst tussen EnerCalculatie (Verwerker) en de Gebruiker (Verwerkingsverantwoordelijke).</p>

          <h2 className="text-xl md:text-2xl font-bold text-slate-800 mt-8 mb-4">1. Doel en aard van de verwerking</h2>
          <p className="text-slate-700 leading-relaxed mb-4">
            Verwerker verbindt zich onder de voorwaarden van deze Verwerkersovereenkomst in opdracht van Verwerkingsverantwoordelijke (het installatiebedrijf) persoonsgegevens te verwerken. De verwerking vindt uitsluitend plaats in het kader van het aanbieden van de EnerCalculatie calculatie- en adviessoftware, waaronder het genereren van energieberekeningen, offertes en adviesrapportages voor eindklanten.
          </p>

          <h2 className="text-xl md:text-2xl font-bold text-slate-800 mt-8 mb-4">2. Instructies en geheimhouding</h2>
          <p className="text-slate-700 leading-relaxed mb-4">
          ...
          <h2 className="text-xl md:text-2xl font-bold text-slate-800 mt-8 mb-4">3. Sub-verwerkers</h2>
          ...
          <h2 className="text-xl md:text-2xl font-bold text-slate-800 mt-8 mb-4">4. Beveiligingsmaatregelen</h2>
          <p className="text-slate-700 leading-relaxed mb-4">
          ...
          <h2 className="text-xl md:text-2xl font-bold text-slate-800 mt-8 mb-4">5. Datalekken</h2>
          <p className="text-slate-700 leading-relaxed mb-4">
          ...
          <h2 className="text-xl md:text-2xl font-bold text-slate-800 mt-8 mb-4">6. Audit-recht</h2>
          <p className="text-slate-700 leading-relaxed mb-4">
          ...
          <h2 className="text-xl md:text-2xl font-bold text-slate-800 mt-8 mb-4">7. Medewerking en assistentie</h2>
          <p className="text-slate-700 leading-relaxed mb-4">
          ...
          <h2 className="text-xl md:text-2xl font-bold text-slate-800 mt-8 mb-4">8. Verwijdering van gegevens</h2>
          <p className="text-slate-700 leading-relaxed mb-4">
          ...
          <h2 className="text-xl md:text-2xl font-bold text-slate-800 mt-8 mb-4">9. Aansprakelijkheid</h2>
          <p className="text-slate-700 leading-relaxed mb-4">
            De aansprakelijkheid van Verwerker voor schade als gevolg van een toerekenbare tekortkoming in de nakoming van deze Verwerkersovereenkomst, een overtreding van de AVG, dan wel uit onrechtmatige daad of anderszins, is te allen tijde strikt beperkt tot hetgeen is overeengekomen in de beperking van aansprakelijkheid (waaronder de financiële cap en de uitsluiting van indirecte schade en dataverlies) zoals vastgelegd in de <a href="/voorwaarden" className="text-brand-primary font-medium hover:underline">Algemene Voorwaarden</a> van EnerCalculatie.
          </p>
