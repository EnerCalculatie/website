        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="prose prose-slate max-w-none">
          <div className="flex justify-end mb-6 print:hidden">
            <button 
              ...
              className="flex items-center gap-2 bg-slate-100 hover:bg-slate-200 text-slate-700 px-5 py-3 rounded-xl text-base font-bold transition-colors cursor-pointer min-h-[48px]"
            >
              <Printer size={18} />
