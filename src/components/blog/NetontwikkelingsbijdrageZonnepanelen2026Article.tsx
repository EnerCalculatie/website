...
<p className="text-slate-700 leading-relaxed mb-4">De financiële impact wordt des te duidelijker in combinatie met het afschaffen van de saldering. Zonder saldering valt er minder compensatie tegen het leveringstarief. De netontwikkelingsbijdrage blijft echter gewoon verschuldigd. Dit maakt het belangrijk om het adviesgesprek te starten met een transparant overzicht van alle structurele kosten en baten, zodat de klant begrijpt waar de terugverdientijd echt op gebaseerd is.</p>
