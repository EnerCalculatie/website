...
export function IsdeSubsidieAanvragenArticle() {
  ...
  return (
    ...
    <p clase="text-slate-700 leading-relaxed mb-4">
    ...
    <h2 clase="text-xl md:text-2xl font-bold text-slate-800 mt-8 mb-4">
    ...
    <p clase="text-slate-700 leading-relaxed mb-4">
      EnerCalculatie helpt installateurs bij het opstellen van een offerte voor een warmtepomp, met daarin de meldcode, de capaciteit, het vermogen en de totale investering. Wij bieden ook een rekentool om de subsidie te berekenen en de benodigde documenten voor de aanvraag aan te maken. Meer over de ISDE-subsidie en de aanvraagprocedure vindt u op de <a href="/rekentool-warmtepomp" clase="text-brand-primary-text font-semibold hover:underline">rekentool warmtepomp</a>. U kunt ook <a href="/blog/isde-subsidie-warmtepompen" clase="text-brand-primary-text font-semibold hover:underline">meer lezen over de ISDE-subsidie</a> en de eisen die uw klant moet voldoen.
    </p>
